	...
	return (
		<footer className="w-full bg-gray-50 border-t border-gray-200 py-10 px-5 mt-auto">
			<div className="max-w-7xl mx-auto flex flex-col items-center">
				<div className="text-base font-bold text-text-primary mb-5">
					{TEXTS.APP_NAME}
				</div>
				<nav className="flex flex-col sm:flex-row items-center justify-center gap-y-4 gap-x-6 mb-6">
					<a
						className="text-sm text-text-secondary hover:text-text-primary hover:underline cursor-pointer transition-colors"
						href="#"
					>
				...
				<div className="relative mb-5">
					<select
						...
						className="pl-8 pr-4 py-2 text-sm bg-white border border-gray-200 text-text-primary rounded-[6px] shadow-sm focus:ring-2 focus:ring-primary focus:border-primary appearance-none cursor-pointer"
					>
